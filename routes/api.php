...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // 5. Like tizimi
    Route::post('/posts/{post}/like', [LikeController::class, 'toggleLike']);                       // like/dislike
    Route::post('/posts/{post}/comment/{comment}/like', [LikeController::class, 'likeComment']);    // like for comment
